...
namespace Moira.ApiClient.Extensions
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static void AddMoiraApiClient(this IServiceCollection services)
        {
            HostConfiguration config = new HostConfiguration(services);
            AddMoiraApiClient(services, config);
        }
        ...
        public static void AddMoiraApiClient(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new HostConfiguration(services);
            options(config);
            AddMoiraApiClient(services, config);
        ...
        internal static void AddMoiraApiClient(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddMoiraApiClientHttpClients();
