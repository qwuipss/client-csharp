...
namespace Moira.ApiClient.Model
{
    ...
    public partial class DtoTeamModel : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DtoTeamModel(Option<string> description = default, Option<string> id = default, Option<string> name = default)
        {
    ...
    public class DtoTeamModelJsonConverter : JsonConverter<DtoTeamModel>
    {
        ...
        public override DtoTeamModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DtoTeamModel(description, id, name);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, DtoTeamModel dtoTeamModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (dtoTeamModel.IdOption.IsSet && dtoTeamModel.Id == null)
                throw new ArgumentNullException(nameof(dtoTeamModel.Id), "Property is required for class DtoTeamModel.");

            if (dtoTeamModel.NameOption.IsSet && dtoTeamModel.Name == null)
            ...
            if (dtoTeamModel.IdOption.IsSet)
                writer.WriteString("id", dtoTeamModel.Id);

            if (dtoTeamModel.NameOption.IsSet)
