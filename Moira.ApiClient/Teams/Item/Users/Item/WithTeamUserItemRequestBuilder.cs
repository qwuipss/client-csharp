...
using System;
namespace Moira.ApiClient.Teams.Item.Users.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \teams\{teamID}\users\{teamUserID}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithTeamUserItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Moira.ApiClient.Teams.Item.Users.Item.WithTeamUserItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTeamUserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{teamID}/users/{teamUserID}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Moira.ApiClient.Teams.Item.Users.Item.WithTeamUserItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTeamUserItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{teamID}/users/{teamUserID}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Moira.ApiClient.Teams.Item.Users.Item.WithTeamUserItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Moira.ApiClient.Teams.Item.Users.Item.WithTeamUserItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
