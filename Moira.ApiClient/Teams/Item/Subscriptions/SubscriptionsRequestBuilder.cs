...
using System;
namespace Moira.ApiClient.Teams.Item.Subscriptions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Moira.ApiClient.Teams.Item.Subscriptions.SubscriptionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Moira.ApiClient.Models.Dto.Subscription?> PostAsync(global::Moira.ApiClient.Models.Dto.Subscription body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Moira.ApiClient.Models.Dto.Subscription> PostAsync(global::Moira.ApiClient.Models.Dto.Subscription body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Moira.ApiClient.Models.Dto.Subscription body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Moira.ApiClient.Models.Dto.Subscription body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Moira.ApiClient.Teams.Item.Subscriptions.SubscriptionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Moira.ApiClient.Teams.Item.Subscriptions.SubscriptionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Moira.ApiClient.Teams.Item.Subscriptions.SubscriptionsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
