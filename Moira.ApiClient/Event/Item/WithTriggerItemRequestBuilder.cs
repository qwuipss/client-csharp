...
using System;
namespace Moira.ApiClient.Event.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Moira.ApiClient.Event.Item.WithTriggerItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Moira.ApiClient.Models.Dto.EventsList"/></returns>
...
#nullable enable
        public async Task<global::Moira.ApiClient.Models.Dto.EventsList?> GetAsync(Action<RequestConfiguration<global::Moira.ApiClient.Event.Item.WithTriggerItemRequestBuilder.WithTriggerItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Moira.ApiClient.Models.Dto.EventsList> GetAsync(Action<RequestConfiguration<global::Moira.ApiClient.Event.Item.WithTriggerItemRequestBuilder.WithTriggerItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Moira.ApiClient.Models.Dto.EventsList>(requestInfo, global::Moira.ApiClient.Models.Dto.EventsList.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets all trigger events for current page and their count
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Moira.ApiClient.Event.Item.WithTriggerItemRequestBuilder.WithTriggerItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Moira.ApiClient.Event.Item.WithTriggerItemRequestBuilder.WithTriggerItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Moira.ApiClient.Event.Item.WithTriggerItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Moira.ApiClient.Event.Item.WithTriggerItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets all trigger events for current page and their count
        /// </summary>
